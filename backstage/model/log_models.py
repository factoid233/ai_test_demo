...
class Log(Base):
    ...
    latency_avg_p70 = Column(Float, comment="表示按升序处理请求时间：第70%位的平均耗时")
    latency_avg_p90 = Column(Float, comment="表示按升序处理请求时间：第90%位的平均耗时")
    latency_avg_p95 = Column(Float, comment="表示按升序处理请求时间：第95%位的平均耗时")
    latency_avg_p99 = Column(Float, comment="表示按升序处理请求时间：第99%位的平均耗时")
