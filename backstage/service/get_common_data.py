...
class GetCommonData:
    ...
    def query_classify_field(self):
        res = DefTypeHandler(self._session).get_classify_field(self._testfunc)
        self.common_data['classify_field'] = res
